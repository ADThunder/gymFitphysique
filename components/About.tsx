...
const featured = [
  {
    ...
    subtitle:
      "Lorem ipsum dolor sit amet consectetur adipisicing elit. Adipisci non numquam accusamus expedita eligendi impedit. ",
  },
  {
    icon: <IoIosPricetags />,
      ...
      <div className="container mx-auto">
        <div className="flex flex-col items-center gap-2 mb-8">
          ...
          >
            ...
            repellendus eveniet ab voluptatem consectetur? Illum.
          </motion.p>
        </div>
        {/* featured items */}
        <motion.div
