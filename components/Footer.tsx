      ...
      <div className="container mx-auto pb-24">
        ...
        >
          ...
          <motion.div variants={footerItem} className="flex flex-col gap-4">
            ...
            <ul className="flex flex-col gap-4">
              ...
              <li className="flex items-center gap-4">
                ...
                <span>(510) 710-3464 (510) 640-6324</span>
              </li>
              <li>
          ...
          <motion.div variants={footerItem} className="">
            <h4 className="h4 text-accent mb4">Recent blog posts</h4>
            {/* post */}
          ...
          <motion.div variants={footerItem}>
            ...
            <div className="flex flex-col gap-4">
              <p>
                ...
                sapiente nisi veritatis dicta nesciunt pariatur ipsa dolor nulla
                molestiae tempore.
              </p>
